...
const MatchInterests = () => {
  ...
  const { loading, data } = useQuery(QUERY_SINGLE_MEETING, {
    ...
    variables: { interestId: interestId },
  });
              ...
              <div className="card-meeting">
                <div className="card-meeting-header">
                  ...
                  <div className="card-meeting-title-group">
                    ...
                    <h6 className="card-meeting-date">
                      Hosted by {meeting.organiser.organiserName}
                    </h6>
                ...
                <img
                  className="card-meeting-image"
                  src={meeting.meetingPhoto}
                  alt="Logo"
                />
                <h2>Details</h2>
                ...
                <div className="card-meeting-like-bar">
                  ...
                  <div>
                    {meeting.onLine === true ? (
                      ...
                      <div>
                        <h2>Location</h2>
                        <div className="card-meeting-date">
                          {meeting.location}
                        </div>
                      </div>
                    )}
